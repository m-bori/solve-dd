<?php
/*
Template Name: select accout-type
*/
?>
                        ...
                        <div class="card bg-white border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 py-3 py-lg-3">
                                <div class="feature text-black  my-3">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/android-logo.png" width="100" height="100" alt="..." />
                                </div>
                                <a href="<?php echo esc_url( home_url( '/create-account-android' ) ); ?>">
                                    <h2 class="fs-4 fw-bold">Androidで作る</h2>
                                </a>
                                <p class="mb-0">Androidをご利用の方</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-xxl-6 mb-5">
                        <div class="card bg-white border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 py-3 py-lg-3">
                                <div class="feature text-black my-3">
                                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/apple-logo.png" width="100" height="100" alt="..." />
                                </div>
                                <a href="<?php echo esc_url( home_url( '/create-account-iphone' ) ); ?>" class="px-0">
                                    <h2 class="fs-4 fw-bold">iPhoneで作る</h2>
                                </a>
                                <p class="mb-0">iPhoneをご利用の方</p>
                            </div>
                        </div>
                    </div>
                </div>
